...
- **Raw Data**: A `data/` folder containing the raw, unmerged accelerometer and gyroscope CSV exports as generated by the MetaMotion wearable logging application.
